        ...
        <div style={styles.card}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div style={styles.group}>
              ...
              <input style={inputStyle('contrasena')} type="password" name="contrasena" value={form.contrasena} onChange={handleChange} placeholder="Tu contraseña" />
              {errors.contrasena && <span style={styles.errorMsg}>⚠ {errors.contrasena}</span>}
            </div>
            <div style={styles.forgotLink}><Link to="/recuperar" style={styles.linkAnchor}>¿Olvidaste tu contraseña?</Link></div>
